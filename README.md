# 📀 DVD Screensaver: The Legend Reborn
...
### Requirements
* [SFML Library](https://www.sfml-dev.org/) must be installed.
* A C++ compiler (g++).

### Compilation
Open your terminal in the project folder and run this command:
```bash
g++ main.cpp -o dvd_screensaver.exe -lsfml-graphics -lsfml-window -lsfml-system
